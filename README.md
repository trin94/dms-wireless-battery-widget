...
live stays as a dimmed stale entry at its last reading until the session ends. Notifications,
the popout, and settings are not implemented yet. The product spec lives in
