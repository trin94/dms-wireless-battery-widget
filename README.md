...
order (mouse, keyboard, controller, headset) that never reshuffles. Stale entries,
notifications, the popout, and settings are not implemented yet. The product spec lives in
